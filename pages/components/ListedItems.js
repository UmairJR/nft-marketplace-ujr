...
const ListedItems = ({ mpContract, nftContract, web3, accounts }) => {
  ...
  return (
    <div className="mt-5 mb-10">
      <h1 className="text-3xl font-bold font-serif mb-5 text-center">Listed NFTs</h1>
        <div className="px-5 grid lg:grid-cols-3 md:grid-cols-2 sm:grid-cols-1 gap-4 justify-center">
          {listedItems.length > 0 ? (
            ...
            <h1 className="text-3xl font-bold font-serif mb-4 text-center">No listed NFTs. Create Your First NFT</h1>
            </main>
          )}
        </div>
    </div>
